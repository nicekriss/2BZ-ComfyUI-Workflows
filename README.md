...
가사와 스타일로 보컬·반주가 있는 곡을 생성합니다. **[YuE2 설치 ZIP · v0.1.0-rc1](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/tag/yue2-v0.1.0-rc1)** → 압축 해제 → `Install-YuE2.bat` → ComfyUI·모델 폴더 선택 → 설치 완료 후 재시작.
