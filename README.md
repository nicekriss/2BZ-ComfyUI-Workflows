...
ZIP 압축을 풀고 `YuE2/Install-YuE2.bat`을 실행하세요. YuE2와 ABC Studio v0.4.4을 함께 설치합니다. [rc10 릴리스 안내](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/tag/yue2-v0.1.0-rc10). [설치·사용 가이드](YuE2/START-HERE-ko.md) · [검증 범위와 남은 한계](YuE2/VALIDATION.md). Windows·NVIDIA 대상 시험 배포이며 모델 가중치는 CC BY-NC 4.0입니다.
