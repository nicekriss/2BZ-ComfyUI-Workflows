...
가사와 스타일로 보컬·반주가 있는 곡을 생성합니다. **[rc4 설치 ZIP 다운로드](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/download/yue2-v0.1.0-rc4/2BZ-YuE2-installer-v0.1.0-rc4.zip)**는 기존 ComfyUI Torch를 보존하며, Torch 2.12.1+cu130에서 설치·43.48초 생성 검증을 완료했습니다. 모델 약 7.8GB 자동 다운로드, 별도 subprocess 실행 환경과 한국어 예제 워크플로를 포함합니다.

ZIP 압축을 풀고 `YuE2/Install-YuE2.bat`을 실행하세요. YuE2와 ABC Studio v0.2.0을 함께 설치합니다. [rc4 릴리스 안내](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/tag/yue2-v0.1.0-rc4). [설치·사용 가이드](YuE2/START-HERE-ko.md) · [검증 범위와 남은 한계](YuE2/VALIDATION.md). Windows·NVIDIA 대상 시험 배포이며 모델 가중치는 CC BY-NC 4.0입니다.
