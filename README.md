...
**[Bridge 설치 ZIP · v0.2.1](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/tag/photoshop-bridge-v0.2.1)** · [설치 안내](Photoshop-Bridge/START-HERE-ko.md) · [기능과 검증 범위](Photoshop-Bridge/README.md)
