# YuE2 음악 생성 설치기 · yue2-v0.1.0-rc9

가사와 음악 스타일을 입력해 보컬과 반주가 있는 곡을 만드는 ComfyUI 워크플로입니다.

## 다운로드와 설치

1. **[2BZ-YuE2-installer-v0.1.0-rc9.zip 다운로드](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/download/yue2-v0.1.0-rc9/2BZ-YuE2-installer-v0.1.0-rc9.zip)**를 받아 압축을 풉니다. `Source code (zip)`이나 BAT 파일 하나만 받지 마세요.
