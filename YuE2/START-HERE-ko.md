# YuE2 음악 생성 설치기 · yue2-v0.1.0-rc3

가사와 음악 스타일을 입력해 보컬과 반주가 있는 곡을 만드는 ComfyUI 워크플로입니다.

## 다운로드와 설치

1. [설치 ZIP 다운로드](https://github.com/nicekriss/2BZ-ComfyUI-Workflows/releases/tag/yue2-v0.1.0-rc3)에서 **2BZ-YuE2-installer-v0.1.0-rc2.zip**을 받아 압축을 풉니다. `Source code (zip)`이나 BAT 파일 하나만 받지 마세요.
...
- Windows, NVIDIA BF16 지원 GPU, Python 3.10–3.13, **Torch 2.10.x**.
- 24GB VRAM 권장. 확인한 생성 환경은 RTX 3090 24GB / RAM 64GB / Python 3.13 / Torch 2.10.0+cu130입니다.
- 다른 Torch 버전에서는 변경 없이 중단합니다. 이 설치기를 위해 기존 ComfyUI의 Torch를 임의로 낮추지 마세요.
...
> 설치 ZIP을 받아 압축을 푼 뒤 Install-YuE2.bat을 실행하세요. ComfyUI 폴더와 모델 저장 폴더를 선택하면 필요한 파일을 자동으로 받습니다. 설치 완료 후 ComfyUI를 재시작하고 YuE2_Music.json을 열면 됩니다. Windows·NVIDIA·Torch 2.10.x 대상 시험 배포이며, 자세한 조건은 설치 안내서를 확인해주세요.
